---
title: "Installation"
description: "Get AgentBuilder up and running in your project"
---

# Installation Guide

AgentBuilder is a Vite plugin that runs as a standalone application or mounts at a subpath of an existing Vite application. It can run locally for development and must be deployed to Cloudflare Workers for production.
...
If you already have a Vite project and want to add AgentBuilder:
