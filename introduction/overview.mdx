...
# What Is AgentBuilder and what are Standard Agents?

The Standard Agent Builder (we'll call it AgentBuilder) is a first-party tool for building, deploying, and managing Standard Agents. Standard Agents are portable agents that adhere to the (not yet released) Standard Agent Specification.
...
<Note>
  Standard Agent Builder (AgentBuilder) is proprietary software owned by FormKit Inc. For licensing inquiries, contact [enterprise@formkit.com](mailto:enterprise@formkit.com). However, the Standard Agent Specification is open source and free to use.
</Note>
...
<CardGroup cols={2}>
  <Card title="Installation" icon="download" href="/introduction/installation">
    Get AgentBuilder up and running in minutes
  </Card>
  <Card title="Architecture" icon="sitemap" href="/introduction/architecture">
    Understand how AgentBuilder works
  </Card>
