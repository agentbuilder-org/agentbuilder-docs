...
Agents provide structure to AI conversations. They let you:

- **Define conversation flows**: Control turn-taking between participants
- **Enable tool usage**: Give AI access to custom capabilities
- **Set boundaries**: Limit turns and define stop conditions
- **Create handoffs**: Route between specialized agents
- **Build workflows**: Chain multiple AI steps together
