...
AgentBuilder provides utility functions to manipulate the execution context from within tools and hooks. All utilities are imported from `@standardagents/builder`:
